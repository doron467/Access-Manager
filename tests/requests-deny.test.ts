...
describe('PATCH /requests/:requestId - reject', () => {
  let requester: any
  let approver: any
  let application: any
  ...
  it('allows an approver to reject a pending request', async () => {
  ...
  it('rejects a requester trying to reject a request', async () => {
    const createdRequest = await createRequest()
  ...
  it('rejects rejecting a nonexistent request', async () => {
    const token = createAccessToken(approver.id)
  ...
  it('rejects rejecting an already approved request', async () => {
    const createdRequest = await createRequest()
